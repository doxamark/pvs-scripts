...
class BernalilloCountyPPScript extends BaseScript {
    async performScraping() {
        ...
        const valueElement = await this.page.$('#Values');
    
        if (!valueElement) {
            console.error('No Value Found. Please check your account number.', this.account);
            return { is_success: false, msg: `No Value Found. Please check your account number. ${this.account}` };
        }
...
export default BernalilloCountyPPScript;
