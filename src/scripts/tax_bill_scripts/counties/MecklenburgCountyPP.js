...
class MecklenburgCountyPP extends BaseScript {
    async performScraping() {
        ...
        // Step 7: Wait for and click the "Go To Bill" link
        await this.page.waitForSelector('#lnkGoToBill');
        await this.page.click('#lnkGoToBill');

        // Step 8: Wait for and click the "Printable Version" button
...
export default MecklenburgCountyPP;
