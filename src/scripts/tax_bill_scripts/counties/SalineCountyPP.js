...
class SalineCountyPPScript extends SpecialScript {
    async performScraping() {
        await this.page.goto(this.accountLookupString, { waitUntil: 'networkidle2' });
        console.log(`Navigated to: ${this.page.url()}`);
        await this.page.waitForSelector("#tpid")
        await this.page.type("#tpid", this.account)
...
export default SalineCountyPPScript;
